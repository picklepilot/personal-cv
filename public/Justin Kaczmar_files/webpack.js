...
/******/ ;(function () {
            ...
            /******/ return Promise.all([disposePromise, applyPromise]).then(
                function () {
                    ...
                    /******/ if (queuedInvalidatedModules) {
                        /******/ return internalApply(options).then(
                            function (list) {
                                /******/ outdatedModules.forEach(
                                    function (moduleId) {
    ...
    /******/ !(function () {
        ...
        /******/ function applyHandler(options) {
            ...
            /******/ return {
                /******/ dispose: function () {
                    /******/ currentUpdateRemovedChunks.forEach(
                        function (chunkId) {
                        ...
                        /******/ if (
                            ...
                            /******/ if (module) {
                                ...
                                /******/ for (
                                    ...
                                    /******/ var acceptCallback =
                                        /******/ module.hot
                                            ._acceptedDependencies[dependency]
                                    /******/ var errorHandler =
                                        /******/ module.hot
                                            ._acceptedErrorHandlers[dependency]
                                    /******/ if (acceptCallback) {
                                        /******/ if (
                                            callbacks.indexOf(
                                                acceptCallback
